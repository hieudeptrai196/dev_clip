...
1. Tải **`DevClip-amd64-installer.exe`** từ [Google Drive](https://drive.google.com/file/d/1Bai7aqQkF1YIXULKCjN6GmsbzsKEmvyF/view?usp=sharing).
2. Chạy file và làm theo các bước. App được cài kèm shortcut ở Start Menu.

**Cách 2 — Portable**
- Tải **`DevClip.exe`** từ [Google Drive](https://drive.google.com/file/d/1Bai7aqQkF1YIXULKCjN6GmsbzsKEmvyF/view?usp=sharing) và chạy thẳng — không cần cài.
